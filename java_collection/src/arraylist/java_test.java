...
public class java_test {
	...
	public static void main(String[] args) {
		...
		ArrayList<book>list = load(); // load메서드로부터 텍스트파일을 불러와 ArrayList에 저장
		for(int i = 0; i < list.size(); i++) { // 배열의 크기는 size메서드로 알 수 있다.
			System.out.println(list.get(i)); //ArrayList에 저장되어있는 배열의 값을 가져오려면 get메서드 사용
		}
