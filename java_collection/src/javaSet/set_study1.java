...
//		System.out.println(set);
		...
		슈붕어빵.add("김민수"); 슈붕어빵.add("여영근"); 슈붕어빵.add("인호성"); 슈붕어빵.add("서종우"); 
		
		
		// 교집합 //
		HashSet<String> 팥X안경 = new HashSet<>(); // 슈 좋아하는 안경쓴 사람
		...
		HashSet<String> 안경X팥좋아 = new HashSet<>();
		it = 팥붕어빵.iterator();
		while(it.hasNext()) {
			String name = it.next();
		...
		// 합집합 //
		// 안경을 착용하고 있고 슈를 좋아하는 사람들
		HashSet<String> 안경과슈 = new HashSet<>();
		it = 슈붕어빵.iterator();
		while(it.hasNext()) {
			안경과슈.add(it.next());
		}
