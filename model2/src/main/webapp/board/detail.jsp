...
<div id="detail_wrap">
	...
	<div class="detail_text">
		<b>${data.id }</b>
		<span class="hit_box"><i class="bi bi-chat-heart-fill"></i>${data.hit }</span>
		<span class="date_box"><i class="bi bi-pencil-square"></i>${data.wdate }</span>
	</div>
	...
	<div id="reply_wrap">
		...
		<h3>답글 작성</h3>
			<form method="post" action="/board_reply.do" id="replyF">
