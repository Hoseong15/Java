...
<!-- 
	...
	core choose : switch문과 비슷한 동작을한다.
...
<!-- 
	...
	jstl - jsp standard tag library
		...
		core - 변수, 조건문, 반복문	
		formatting - 낢짜, 시간, 숫자, 통화단위, 텍스트 등을 표시하는 방법
		functions - 메서드를 사용 할 수 있는 라이브러리
		database - 데이버베이스 상호작용 라이브러리
