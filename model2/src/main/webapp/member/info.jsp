...
<c:if test="${sessionScope.uesr != null }">
	<script> alert("먼저 로그인 해주세요"); history.back();</script>
</c:if>

<c:set var="img" value=""/>
<c:if test="${user.image !=null }">
	<c:set var="img" value="style='background:url(http://192.168.0.68/static/image/${use.image }) no-repeat center; background-size:contain;'"/>
</c:if>
			...
			<div class="item login_history">
				...
				<ul class="login_list">
					<li class="list_head">
						...
						<b class="blocking"><a href="">접속제한</a></b>
					</li>
